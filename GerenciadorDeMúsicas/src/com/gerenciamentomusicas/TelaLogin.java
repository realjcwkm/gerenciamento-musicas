...
public class TelaLogin extends JFrame {
    ...
    public TelaLogin() {
        ...
        // --- INÍCIO DAS CORREÇÕES PARA OS LINKS ---
        ...
        // Adicionar o mesmo tamanho máximo e preferido dos campos de texto/botões para alinhamento visual
        this.linkRecuperarSenha.setMaximumSize(new Dimension(300, 20)); // Altura menor para links
        this.linkRecuperarSenha.setPreferredSize(new Dimension(300, 20));
        // Opcional: Adicionar uma borda vazia para simular padding e centralizar o texto dentro da área de 300px
        this.linkRecuperarSenha.setBorder(BorderFactory.createEmptyBorder(0, 15, 0, 15)); // Mesma padding lateral dos campos
        ...
        // Adicionar o mesmo tamanho máximo e preferido
        ...
        painelConteudo.add(Box.createRigidArea(new Dimension(0, 25)));
        // --- FIM DAS CORREÇÕES PARA OS LINKS ---
        ...
        // Ajustar também o "ou" para a mesma largura visual
        ...
        // Adicionar o mesmo tamanho máximo e preferido para o painel de botões sociais
        // para que ele se alinhe com os outros componentes
        painelBotoesSociais.setMaximumSize(new Dimension(300, 40)); // Altura dos botões
    ...
    // Método main opcional para testar a TelaLogin isoladamente
